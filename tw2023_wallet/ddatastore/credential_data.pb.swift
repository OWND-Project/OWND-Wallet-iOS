...
struct Datastore_CredentialDataList {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var items: [Datastore_CredentialData] = []
...
extension Datastore_CredentialDataList: @unchecked Sendable {}
...
extension Datastore_CredentialDataList: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CredentialDataList"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "items"),
  ]
  ...
  static func ==(lhs: Datastore_CredentialDataList, rhs: Datastore_CredentialDataList) -> Bool {
